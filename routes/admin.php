...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'customized', 'as' => 'delivery-man.'], function () {
            ...
            Route::group(['prefix' => 'ordered', 'as' => 'reviews.'], function () {
        ...
        Route::group(['prefix' => 'orders', 'as' => 'orders.'], function () {
            ...
            Route::get('print-image/{id}', 'OrderController@print_image')->name('print-image');
            Route::get('print-address/{id}', 'OrderController@print_address')->name('print-address');
            Route::get('check-cate/{cat_id}', 'OrderController@check_cate')->name('check-cate');
        ...
        Route::group(['prefix' => 'category', 'as' => 'category.'], function () {
            ...
            Route::get('customize-index', 'CategoryController@customize_index')->name('customize-index');
        });
