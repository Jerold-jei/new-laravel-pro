...
@section('title', translate('Add new Appalam image'))
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-add-circle-outlined"></i> {{\App\CentralLogics\translate('add')}} {{\App\CentralLogics\translate('new')}} {{\App\CentralLogics\translate('Appalam')}} {{\App\CentralLogics\translate('image')}}</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
                ...
                <form action="{{route('admin.delivery-man.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="f_name" class="form-control" placeholder="{{\App\CentralLogics\translate('appalam')}} {{\App\CentralLogics\translate('image')}} {{\App\CentralLogics\translate('name')}}"
                                       required>
                            </div>
                        </div>
                        <!-- <div class="col-md-6 col-12">
                    ...
                    <!-- <div class="row">
                        ...
                        <!-- <div class="col-md-12 col-12">
                            <div class="form-group">
                                <label class="input-label" for="exampleFormControlInput1">{{\App\CentralLogics\translate('appalam')}} {{\App\CentralLogics\translate('image')}}</label>
                                <div>
