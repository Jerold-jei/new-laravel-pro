...
@section('title', translate('Customized List'))
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-filter-list"></i> {{\App\CentralLogics\translate('customized')}} {{\App\CentralLogics\translate('appalam')}} <span class="text-primary">{{ $delivery_men->total() }}</span></h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
            ...
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                ...
                <div class="card">
                    ...
                    <div class="card-header flex-between">
                        ...
                        <div>
                            <a href="{{route('admin.delivery-man.add')}}" class="btn btn-primary pull-right"><i
                                    class="tio-add-circle"></i> {{\App\CentralLogics\translate('add')}} {{\App\CentralLogics\translate('customized')}} {{\App\CentralLogics\translate('image')}}</a>
                        </div>
                    </div>
                    <!-- End Header -->
                    ...
                    <div class="table-responsive data table-custom">
                        <table class="table table-border less table-thead-bordered table-nowrap table-align-middle card-table">
                                    ...
                                    <td>
                                        <div style="height: 60px; width: 60px; overflow-x: hidden;overflow-y: hidden">
                                            <img width="60" style="border-radius: 50%"
                                                 ...
                                                 src="{{asset('storage/app/public/customized')}}/{{$dm['image']}}">
                                        </div>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                ...
                                                <a class="dropdown-item" href="javascript:"
                                                   onclick="form_alert('delivery-man-{{$dm['id']}}','{{translate('Want to delete this attribute ?')}}')">{{\App\CentralLogics\translate('delete')}}</a>
