...
@section('content')
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header"
            ...
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    ...
                    <p>{{\App\CentralLogics\translate('welcome')}} {{\App\CentralLogics\translate('admin')}}, {{\App\CentralLogics\translate('_here_is_your_business_statistics')}}.</p>
                </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-4 graph-border-1">
                                <div class="mt-2 center-div">
                                      <span class="h6 mb-0">
                                          <i class="legend-indicator"
                                             style="background-color: #B6C867!important;"></i>
                                         {{ \App\CentralLogics\translate('earnings') }} : {{ Helpers::set_symbol(array_sum($earning)) }}
                                    </span>
                                </div>
                            </div>
                        </div>
        ...
        <div class="row gx-2 gx-lg-3">
            ...
            <div class="col-lg-6 mt-3 mb-lg-0">
                <div class="card h-100">
