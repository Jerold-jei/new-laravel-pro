...
@section('title', \App\CentralLogics\translate('Customize List'))
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-add-circle-outlined"></i> {{\App\CentralLogics\translate('customize')}} {{\App\CentralLogics\translate('image')}} {{\App\CentralLogics\translate('list')}}</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
