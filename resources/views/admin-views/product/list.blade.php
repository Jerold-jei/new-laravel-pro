            ...
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i
                            class="tio-filter-list"></i> {{\App\CentralLogics\translate('product')}} {{\App\CentralLogics\translate('list')}}
                        <span
                            class="badge badge-soft-dark ml-2">{{$products->total()}}</span></h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
                        ...
                        <div class="row justify-content-between align-items-center flex-grow-1">
                            ...
                            <div class="col-md-6">
                                <a href="{{route('admin.product.add-new')}}" class="btn btn-primary float-right"><i
                                        class="tio-add-circle"></i> {{\App\CentralLogics\translate('add')}} {{\App\CentralLogics\translate('new')}} {{\App\CentralLogics\translate('product')}}
                                </a>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                ...
                                                <a class="dropdown-item" href="javascript:"
                                                   onclick="form_alert('product-{{$product['id']}}','{{\App\CentralLogics\translate('Want to delete this item ?')}}')">{{\App\CentralLogics\translate('delete')}}</a>
